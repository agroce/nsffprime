...
the Mars Science Laboratory (Curiosity Rover) project, and was awarded
the NASA Software of the Year Award for 2013 as part of the Curiosity
Rover team.

He received his PhD under the late Turing laureate Edmund M. Clarke, Jr., as one
...
the lead of the DeepState, {\tt universalmutator}, and TSTL design and development teams.
...
project, and {\tt universalmutator}, the other primary software base for
this project), all with more than 100 GitHub ``stars'' (over 800 in
the case of DeepState, one of the top 75 fuzzing-related repos hosted on GitHub); he reports 50-100
...
has consistently involved a marriage of deep theory of testing and
analysis with practical work oriented towards use by real-world
developers and implemented in working tools.


\subsection{Meeting Developers Where They Are}
