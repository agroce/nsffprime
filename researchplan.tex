...
position, this will be re-allocated to hire undergraduates to work on implementation tasks,
recruited from PI Groce's upper-level testing and software engineering classes.