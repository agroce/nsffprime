...
with JPL.  As noted in the letter of collaboration, JPL leads in the FPrime project have agreed to resume past discussions of integration of more powerful automated testing methods into FPrime workflow, and to guide the project in choosing suitable benchmark examples to use in developing the techniques.