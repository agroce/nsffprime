...
construction costs.  Building software with extremely rigorous correctness requirements,
...
also usually involved, poses a serious challenge.
...
around a set of C++ components that
...
perturbed command dictionaries, we can create realistic,
framework-relevant mutants that measure the adequacy of both manual and automatically generated tests.
