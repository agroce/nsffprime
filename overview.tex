...
perturbed command dictionaries, we can create realistic, framework-relevant mutants that measure the adequacy of both developer-written and automatically generated tests.
